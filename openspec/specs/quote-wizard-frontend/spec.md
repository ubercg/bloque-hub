...
Established by REQ-013 (`req-013-portal-hmac`). REQ-012 (`quote-request-folio`)
did not define frontend gate error-state handling as its own domain — its
wizard-step field validation and UX lives in `quote-request-submission` instead.
