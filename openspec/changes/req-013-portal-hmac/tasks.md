...
**Phase 7 status:** 5/7 done (7.1, 7.2, 7.3, 7.6, 7.7). 7.4/7.5 remain blocked on external Portal-team credential delivery (§11.2) — not fakeable, not started beyond the blocking note above.
